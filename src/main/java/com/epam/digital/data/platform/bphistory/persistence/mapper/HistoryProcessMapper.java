...
public interface HistoryProcessMapper {

  BpmHistoryProcess toEntity(HistoryProcess historyProcess);

  @BeanMapping(nullValuePropertyMappingStrategy = NullValuePropertyMappingStrategy.IGNORE)
  BpmHistoryProcess updateEntity(HistoryProcess historyProcess, @MappingTarget BpmHistoryProcess bpmHistoryProcess);
}
